...
class BookingItem implements Arrayable, Jsonable
{
    /**
    ...
    public function __construct($id, $name, $price, array $options = [])
    {
        ...
        $this->options  = new BookingItemOptions($options);
    ...
    public function updateFromArray(array $attributes)
    {
        ...
        $this->priceTax = $this->price + $this->tax;
        $this->options  = new BookingItemOptions(Arr::get($attributes, 'options', $this->options));
