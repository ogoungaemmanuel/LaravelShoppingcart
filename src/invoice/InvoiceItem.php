...
class InvoiceItem implements Arrayable, Jsonable
{
    /**
    ...
    public function __construct($id, $name, $price, array $options = [])
    {
        ...
        $this->options  = new InvoiceItemOptions($options);
    ...
    public function updateFromArray(array $attributes)
    {
        ...
        $this->priceTax = $this->price + $this->tax;
        $this->options  = new InvoiceItemOptions(Arr::get($attributes, 'options', $this->options));
