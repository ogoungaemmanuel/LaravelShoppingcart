...
class ExpenseItem implements Arrayable, Jsonable
{
    /**
     * The rowID of the expense item.
     *
     * @var string
     */
    public $rowId;
    ...
    /**
     * The quantity for this expense item.
     *
     * @var int|float
     */
    public $qty;
    ...
    /**
     * The price without TAX of the expense item.
     *
     * @var float
     */
    public $price;
    ...
    /**
     * The options for this expense item.
     *
     * @var array
     */
    public $options;
    ...
    /**
     * The tax rate for the expense item.
     *
     * @var int|float
     */
    private $taxRate = 0;
    ...
    public function __construct($id, $name, $price, array $options = [])
    {
        ...
        $this->options  = new ExpenseItemOptions($options);
     ...
     * Subtotal is price for whole ExpenseItem without TAX
     *
     * @param int    $decimals
     * @param string $decimalPoint
     * @param string $thousandSeperator
     ...
     * Total is price for whole ExpenseItem with TAX
     *
     * @param int    $decimals
     * @param string $decimalPoint
     * @param string $thousandSeperator
    ...
    /**
     * Set the quantity for this expense item.
     *
     * @param int|float $qty
     */
    ...
    /**
     * Update the expense item from a Buyable.
     *
    ...
    /**
     * Update the expense item from an array.
     *
    ...
    public function updateFromArray(array $attributes)
    {
        ...
        $this->priceTax = $this->price + $this->tax;
        $this->options  = new ExpenseItemOptions(Arr::get($attributes, 'options', $this->options));

        $this->rowId = $this->generateRowId($this->id, $this->options->all());
    }

    /**
     * Associate the expense item with the given model.
     *
     * @param mixed $model
    ...
    /**
     * Get an attribute from the expense item or get the associated model.
     *
