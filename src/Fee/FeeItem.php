...
class FeeItem implements Arrayable, Jsonable
{
    /**
     * The rowID of the fee item.
     *
     * @var string
     */
    public $rowId;
    ...
    /**
     * The quantity for this fee item.
     *
     * @var int|float
     */
    public $qty;
    ...
    /**
     * The price without TAX of the fee item.
     *
     * @var float
     */
    public $price;
    ...
    public function __construct($id, $name, $price, array $options = [])
    {
        ...
        $this->options  = new FeeItemOptions($options);
     ...
     * Subtotal is price for whole FeeItem without TAX
     *
     * @param int    $decimals
     * @param string $decimalPoint
     * @param string $thousandSeperator
     ...
     * Total is price for whole FeeItem with TAX
     *
     * @param int    $decimals
     * @param string $decimalPoint
     * @param string $thousandSeperator
    ...
    /**
     * Set the quantity for this fee item.
     *
     * @param int|float $qty
     */
    ...
    /**
     * Update the fee item from a Buyable.
     *
    ...
    /**
     * Update the fee item from an array.
     *
    ...
    public function updateFromArray(array $attributes)
    {
        ...
        $this->priceTax = $this->price + $this->tax;
        $this->options  = new FeeItemOptions(Arr::get($attributes, 'options', $this->options));

        $this->rowId = $this->generateRowId($this->id, $this->options->all());
    }

    /**
     * Associate the fee item with the given model.
     *
     * @param mixed $model
    ...
    /**
     * Get an attribute from the fee item or get the associated model.
     *
    ...
    /**
     * Generate a unique id for the fee item.
     *
     * @param string $id
     * @param array  $options
     * @return string
